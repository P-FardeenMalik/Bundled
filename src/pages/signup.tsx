...
const SignUpPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Sign Up - Bundled</title>
        <meta name="description" content="Create your Bundled account to access next-generation crypto marketing services." />
          ...
          <Card className="bg-gray-900/50 border-white/10 backdrop-blur-sm" onKeyDown={handleKeyPress}>
            <CardHeader className="text-center pb-6">
              ...
              <p className="text-gray-400 text-sm mt-2">
                Create your account to accelerate your Web3 growth
              </p>
            </CardHeader>
